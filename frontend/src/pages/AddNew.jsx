...
const AddNew = () => {
  return (
    <>
    <Link className='px-4 py-2 bg-blue-200 rounded-md' to='/'>Back</Link>
    <div className='text-xl'>Add new book</div>
    <form action="http://localhost:3000/books/addNew" method="post" className='flex flex-col gap-2'>
      ...
      <button action="submit" className='px-4 py-2 bg-blue-200 rounded-md'>Add</button>
